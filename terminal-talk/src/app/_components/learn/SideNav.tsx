...
import { calculateProgress } from '@/app/_lib/services/utilService';
...
export default function SideNav() {
  ...
  // pull the one saved userCourse record (or default)
  const [{ progress, completed } = { progress: 0, completed: false }] =
    course.userCourses;

  // compute percent based on your UI index
  // const percent = calculateProgress(progress, course.lectures.length);
  const percent = Math.round((progress / course.lectures.length) * 100);
  return (

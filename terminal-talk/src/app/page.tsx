  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative z-10">
        {/* Navigation Bar */}
        <nav className="absolute top-0 left-0 right-0 flex items-center justify-between px-4 py-4 md:px-8">
          {/* Logo/Brand */}
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="px-4 py-2 bg-transparent border border-gray-500 text-gray-200 text-[13px] font-medium rounded-lg hover:border-gray-400 hover:text-white transition-all">
              Log in
            </button>
